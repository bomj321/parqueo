          ...
          <style type="text/css">
            .mensaje_alerta_configuracion{
              font-size: 2em;              
                   ...
                   <!-- <form class="form-horizontal" enctype="multipart/form-data" onsubmit="configurar(); return false" id="configurar_data" action="">-->
							<form class="form-horizontal" enctype="multipart/form-data" method="POST" id="configurar_data" action="../ajax/configurar_data.php">
                             ...
                             <div class="form-group col-md-12">
		                              <label class="control-label">Tipo de Parqueo</label>
		                                 <select name="tipo_parqueo" class="form-control" required>									            
								              ...
								              <option value="Moto/Carro">Moto/Carro</option>
						            </select>
